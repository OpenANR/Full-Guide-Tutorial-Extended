...
Saat ini, panduan konfigurasi web server tersedia untuk sistem operasi/distribusi berikut:

*   **[Arch Linux](arch-linux/index.md)**
    Langkah-langkah instalasi dan konfigurasi web server stack (LAMP/LNMP) di Arch Linux, meliputi MariaDB database, PHP, dan phpMyAdmin.
